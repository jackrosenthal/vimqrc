...
% Updated 2018 - Jack Rosenthal
% https://github.com/jackrosenthal/vimqrc
% TeX Format
...
\cm{=$m$}{indent lines on movement $m$}
...
\sect{Visual mode}
\cm{v}{visual mode}
\cm{V}{visual line mode}
\cm{\ctrl V}{visual block mode}
...
{\smallrm
{\smalltt https://github.com/jackrosenthal/vimqrc}

This card may be freely distributed under
the terms of the GNU General Public License ---
based on work
\copyright\ {\oldstyle 2003} by Laurent Gr\'egoire
$\langle${\smalltt laurent.gregoire@icam.fr}$\rangle$ ---
